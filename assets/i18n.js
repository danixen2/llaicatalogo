const I18N = {
  es: {
    ...
    nav_categories: 'Grupos Idol', nav_contact: 'Contacto', nav_cart: 'Carrito',
    ...
    add_to_cart: 'Agregar al carrito', added_to_cart: '¡Agregado!',
  ...
  en: {
    ...
    nav_categories: 'Idol Groups', nav_contact: 'Contact', nav_cart: 'Cart',
  ...
  ja: {
    ...
    nav_categories: 'アイドルグループ', nav_contact: 'お問い合わせ', nav_cart: 'カート',
    ...
    add_to_cart: 'カートに追加', added_to_cart: '追加しました！',
